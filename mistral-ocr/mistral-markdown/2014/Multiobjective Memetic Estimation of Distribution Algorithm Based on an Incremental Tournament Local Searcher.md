...
| :--: | :--: | :--: | :--: |
| ZDT1 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\sqrt{f_{1}(\mathbf{x}) / g(\mathbf{x})}\right] \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n} x_{i}\right) /(n-1) \end{gathered}$ | 50000 |
| ZDT2 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\left(f_{1}(\mathbf{x}) / g(\mathbf{x})\right)^{2}\right] \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n} x_{i}\right) /(n-1) \end{gathered}$ | 50000 |
| ZDT3 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\sqrt{f_{1}(\mathbf{x}) / g(\mathbf{x})}-f_{1}(\mathbf{x}) / g(\mathbf{x}) \sin \left(10 \pi x_{1}\right)\right] \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n} x_{i}\right) /(n-1) \end{gathered}$ | 50000 |
| ZDT4 | $\begin{gathered} x_{1 \in[0,1]} \\ x_{2 \in[-5,5]} \\ i=2, \ldots, 10 \end{gathered}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\sqrt{f_{1}(\mathbf{x}) / g(\mathbf{x})}\right] \\ g(\mathbf{x})=1+10(n-1)+\sum_{i=2}^{n}\left[x_{i}^{2}-10 \cos \left(4 \pi x_{i}\right)\right] \end{gathered}$ | 50000 |
| ZDT6 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=10 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=1-\exp \left(-4 x_{1}\right) \sin ^{6}\left(6 \pi x_{1}\right) \\ f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\left(f_{1}(\mathbf{x}) / g(\mathbf{x})\right)^{2}\right] \\ g(\mathbf{x})=1+9\left[\left(\sum_{i=2}^{n} x_{i}\right) /(9)\right]^{0.25} \end{gathered}$ | 50000 |
| DTLZ1 | $\begin{gathered} {[0,1]^{\mathrm{n}}} \\ n=7 \\ \mathbf{x}_{M}=[0,1]^{3} \end{gathered}$ | $\begin{gathered} f_{1}(\mathbf{x})=0.5 x_{1} x_{2}(1+g(\mathbf{x})) \\ f_{2}(\mathbf{x})=0.5 x_{1}\left(1-x_{2}\right)(1+g(\mathbf{x})) \\ f_{3}(\mathbf{x})=0.5\left(1-x_{1}\right)(1+g(\mathbf{x})) \\ g(\mathbf{x})=100\left[\left|\mathbf{x}_{M}\right|+\sum_{x_{i} \in S_{M}}\left(\left(x_{i}-0.5\right)^{2}-\cos \left(20 \pi\left(x_{i}-0.5\right)\right)\right)\right] \end{gathered}$ | 60000 |
| DTLZ2 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=12 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=\cos \left(0.5 \pi x_{1}\right) \cos \left(0.5 \pi x_{2}\right)(1+g) \\ f_{2}(\mathbf{x})=\cos \left(0.5 \pi x_{1}\right) \sin \left(0.5 \pi x_{2}\right)(1+g) \\ f_{3}(\mathbf{x})=\sin \left(0.5 \pi x_{1}\right)(1+g) \\ & g(\mathbf{x})=\sum_{i=1}^{n}\left(x_{i}-0.5\right)^{2} \end{aligned}$ | 50000 |
| DTLZ3 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=12 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=\cos \left(0.5 \pi x_{1}\right) \cos \left(0.5 \pi x_{2}\right)(1+g) \\ f_{2}(\mathbf{x})=\cos \left(0.5 \pi x_{1}\right) \sin \left(0.5 \pi x_{2}\right)(1+g) \\ f_{3}(\mathbf{x})=\sin \left(0.5 \pi x_{1}\right)(1+g) \\ & g(\mathbf{x})=100\left[\left|\mathbf{x}_{M}\right|+\sum_{i=1}^{n}\left(\left(x_{i}-0.5\right)^{2}-\cos \left(20 \pi\left(x_{i}-0.5\right)\right)\right)\right] \end{gathered}$ | 50000 |
| DTLZ4 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=12 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=\cos \left(0.5 \pi x_{1}{ }^{\mathrm{n}}\right) \cos \left(0.5 \pi x_{2}{ }^{\mathrm{n}}\right)(1+g) \\ f_{2}(\mathbf{x})=\cos \left(0.5 \pi x_{1}{ }^{\mathrm{n}}\right) \sin \left(0.5 \pi x_{2}{ }^{\mathrm{n}}\right)(1+g) \\ f_{3}(\mathbf{x})=\sin \left(0.5 \pi x_{1}{ }^{\mathrm{n}}\right)(1+g) \\ & g(\mathbf{x})=\sum_{i=1}^{n}\left(x_{i}-0.5\right)^{2} \quad \alpha=100 \end{aligned}$ | 50000 |
| DTLZ6 | $\begin{gathered} {[0,1]^{\mathrm{n}}} \\ n=22 \\ \mathbf{x}_{M}=[0,1]^{20} \end{gathered}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ f_{2}(\mathbf{x})=x_{2} \\ g\left(\mathbf{x}_{M}\right)=1+0.45 \sum x_{i} \\ h=3-f_{2} /(1+g)\left(1+\sin \left(3 \pi f_{1}\right)\right)-f_{3} /(1+g)\left(1+\sin \left(3 \pi f_{2}\right)\right) \end{gathered}$ | 50000 |
| F1 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) /(n-1) \end{gathered}$ | 15000 |
| F2 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) /(n-1) \end{gathered}$ | 15000 |
| F3 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=1-\exp \left(-4 x_{1}\right) \sin ^{6}\left(6 \pi x_{1}\right) \\ f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\left(f_{1}(\mathbf{x}) / g(\mathbf{x})\right)^{2}\right] \\ g(\mathbf{x})=1+9\left[\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) / 9\right]^{0.25} \end{aligned}$ | 100000 |
| F4 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=\cos \left(0.5 \pi x_{1}\right) \cos \left(0.5 \pi x_{2}\right)(1+g) \\ f_{2}(\mathbf{x})=\cos \left(0.5 \pi x_{1}\right) \sin \left(0.5 \pi x_{2}\right)(1+g) \\ f_{3}(\mathbf{x})=\sin \left(0.5 \pi x_{1}\right)(1+g) \\ & g(\mathbf{x})=\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2} \end{aligned}$ | 35000 |
| F5 | $\begin{aligned} & {[0,1]^{\mathrm{n}}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) /(n-1) \end{gathered}$ | 15000 |

Table I: Continued.

| Instance | Variable | Objectives | Number of evaluations |
| :--: | :--: | :--: | :--: |
| F6 | $\begin{aligned} & {[0,1]^{n}} \\ & n=30 \end{aligned}$ | $\begin{gathered} f_{1}(\mathbf{x})=x_{1} \quad f_{2}(\mathbf{x})=g(\mathbf{x})\left[1-\left(f_{1}(\mathbf{x}) / g(\mathbf{x})\right)^{2}\right] \\ g(\mathbf{x})=1+9\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) /(n-1) \end{gathered}$ | 15000 |
...
[31] K. Deb, M. Mohan, and S. Mishra, "Evaluating the $\varepsilon$-domination based multi-objective evolutionary algorithm for a quick computation of Pareto-optimal solutions," Evolutionary Computation, vol. 13, no. 4, pp. 501-525, 2005.
