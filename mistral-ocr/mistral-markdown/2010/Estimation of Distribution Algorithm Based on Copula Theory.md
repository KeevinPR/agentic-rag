...
| $F_{9}$ | $3.0000 \pm 9.9700 \mathrm{e}-9$ | 7.8600 | $\pm 10.4784$ | 3.0116 | $\pm 0.0206$ |
...
| Algorithm | Selection rate | $\sigma$ | F1 |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  |  |  | mean | StdVar | min | max |
| $\begin{aligned} & \mathrm{UMDA}_{v}^{D} \\ & \mathrm{MIMIC}_{v}{ }^{G} \\ & \mathrm{EGNA}_{i e} \\ & \mathrm{EGNA}_{\text {BGe }} \\ & \text { ES } \end{aligned}$ |  |  | $\begin{gathered} -53460 \\ -58775 \\ -100000 \\ -100000 \\ -5910 \end{gathered}$ |  |  |  |
| $\mathrm{cEDA}_{\mathrm{PG}}$ | 0.5 | A:0.02 | $-30.2775$ | 3.4345 | $-37.9727$ | $-26.2 .83$ |
|  | 0.5 | A:0.05 | $-12.5174$ | 1.4837 | $-15.7628$ | $-11.0210$ |
|  | 0.2 B | B | $-60770$ | 27564 | -99866 | -6390.9 |
|  | 0.2 | B | $-1074.6$ | 482.2301 | $-2168.2$ | $-513.8331$ |
|  | 0.5 | C | $-184.0976$ | 52.9640 | $-235.0931$ | $-46.0561$ |
|  | $1 / 3$ | C | $-561.7312$ | 178.8254 | $-764.9960$ | $-114.3033$ |
|  | 0.2 B | C | -9910.3 | 2692.9 | $-12511$ | $-2786.9$ |
|  | 0.2 | C | -2089.4 | 587.4801 | $-2784.2$ | $-547.5289$ |

Table 5 The comparison among cEDA and other algorithms on Schwefel function

| Algorithm | Selection rate | $\sigma$ | F2 |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  |  |  | mean | StdVar | min | max |
| $\begin{aligned} & \text { UMDA }{ }_{c}^{\mathrm{TT}} \\ & \text { MIMIC }{ }_{c}^{\mathrm{G}} \\ & \text { EGNA }{ }_{\mathrm{ee}} \\ & \text { EGNA }{ }_{\mathrm{BGe}} \\ & \text { ES } \end{aligned}$ |  |  | $\begin{gathered} 0.13754 \\ 0.13397 \\ 0.09914 \\ 0.0250 \\ 0 \end{gathered}$ |  |  |  |
| $\mathrm{cEDA}_{\mathrm{PG}}$ | 0.5 | A:. 02 | 4.0743 | 0.8572 | 2.8008 | 5.3325 |
|  | 0.5 | A:. 05 | 0.0097 | 0.0032 | 0.0061 | 0.0167 |
|  | 0.2 B | B | $2.3833 \times 10^{-4}$ | $\begin{gathered} 5.2429 \times \\ 10^{-5} \end{gathered}$ | $\begin{gathered} 1.2190 \times \\ 10^{-4} \end{gathered}$ | $3.6281 \times 10^{-4}$ |
|  | 0.2 | B | 0.1478 | 0.0259 | 0.1066 | 0.1954 |
|  | 0.5 | C | $8.2443 \times 10^{-4}$ | 0.0019 | $\begin{gathered} 1.0471 \times \\ 10^{-4} \end{gathered}$ | 0.0063 |
|  | $1 / 3$ | C | $1.8707 \times 0^{-5}$ | $\begin{gathered} 4.6817 \times \\ 10^{-5} \end{gathered}$ | $\begin{gathered} 2.8442 \times \\ 10^{-6} \end{gathered}$ | $\begin{gathered} 1.5194 \times \\ 10^{-4} \end{gathered}$ |
|  | 0.2 | C | $3.0034 \times 10^{-7}$ | $\begin{gathered} 7.3179 \times \\ 10^{-7} \end{gathered}$ | $\begin{gathered} 4.0579 \times \\ 10^{-8} \end{gathered}$ | $\begin{gathered} 2.3825 \times \\ 10^{-6} \end{gathered}$ |

Table 6 The comparison among cEDA and other algorithms on Griewank function

| Algorithm | Selection <br> rate | $\sigma$ | F3 |  |  |  |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  |  |  | mean | StdVar | min | max |
| $\begin{aligned} & \text { UMDA }_{\mathrm{c}}^{\mathrm{TT}} \\ & \text { MIMIC }_{\mathrm{c}}^{\mathrm{G}} \\ & \text { EGNA }_{\mathrm{ee}} \\ & \text { EGNA }_{\mathrm{BGe}} \\ & \text { ES } \end{aligned}$ |  |  | $\begin{gathered} 0.011076 \\ 0.007794 \\ 0.008175 \\ 0.012605 \\ 0.034477 \end{gathered}$ |  |  |  |
| $\mathrm{cEDA}_{\mathrm{PG}}$ | 0.5 | A:. 02 | 1.0796 | 0.1977 | 0.6106 | 1.2775 |
|  | 0.5 | A:. 05 | 0.5489 | 0.3694 | 0.2215 | 1.4507 |
|  | 0.2 B | B | 0.0046 | 0.0151 | 0 | 0.0857 |
|  | 0.2 | B | 0 | 0 | 0 | 0 |
|  | 0.5 | C | $1.3192 \times 10^{-9}$ | $\begin{gathered} 3.1529 \times \\ 10^{-9} \end{gathered}$ | $\begin{gathered} 1.2085 \times \\ 10^{-10} \end{gathered}$ | $\begin{gathered} 1.0288 \times \\ 10^{-8} \end{gathered}$ |
|  | $1 / 3$ | C | $4.2966 \times 10^{-14}$ | $\begin{gathered} 1.0565 \times \\ 10^{-15} \end{gathered}$ | $\begin{gathered} 7.2164 \times \\ 10^{-15} \end{gathered}$ | $\begin{gathered} 3.4361 \times \\ 10^{-13} \end{gathered}$ |
|  | 0.2 | C | 0 | 0 | 0 | 0 |
