...
| Number of airships |  |  | Single hotspot shift | Divided single hotspot | Two hotspots shift | Dispersed single hotspot |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 4 | SBX-PN | $t$ test $p$ <br> Better | 0 <br> YES | 0 <br> YES | 0 <br> YES | 0 <br> YES |
|  | DE-PN | $t$ test $p$ <br> Better | 0 <br> YES | 0 <br> YES | 0 <br> YES | 0 <br> YES |
|  | BLX-NU | $t$ test $p$ <br> Better | 0 <br> YES | 0 <br> YES | 0 <br> YES | 0 <br> YES |
|  | GC-NU | $t$ test $p$ <br> Better | 0 <br> YES | 0.006 | 0 | 0 |
|  |  |  |  | YES | YES | YES |
| 5 | SBX-PN | $t$ test $p$ <br> Better | 0 <br> YES | 0 <br> YES | 0 <br> YES | 0 <br> YES |
|  | DE-PN | $t$ test $p$ <br> Better | 0 <br> YES | 0.001 | 0 | 0 |
|  | BLX-NU | $t$ test $p$ <br> Better | 0.016 | 0 | 0 | 0 |
|  |  |  | YES | YES | YES | YES |
|  | GC-NU | $t$ test $p$ <br> Better | 0.003 | 0 | 0 | 0 |
|  |  |  | YES | YES | YES | YES |
| 6 | SBX-PN | $t$ test $p$ <br> Better | 0.094 | 0.003 | 0 | 0 |
|  |  |  | No | YES | YES | YES |
|  | DE-PN | $t$ test $p$ <br> Better | 0 <br> YES | 0.008 | 0.046 | 0 |
|  |  |  | YES | YES | YES | YES |
|  | BLX-NU | $t$ test $p$ <br> Better | 0.809 | 0.123 | 0.019 | 0.002 |
|  |  |  | Worse | Worse |  |  |
|  | GC-NU | $t$ test $p$ <br> Better | 0.758 | 0.005 | 0.002 | 0.004 |
|  |  |  | No | Worse |  |  |
| 8 | SBX-PN | $t$ test $p$ <br> Better | 0.778 | 0.682 | 0.187 | 0 |
|  |  |  | No | No |  |  |
|  | DE-PN | $t$ test $p$ <br> Better | 0.004 | 0.210 | 0.431 | 0.357 |
|  |  |  | YES | No |  |  |
|  | BLX-NU | $t$ test $p$ <br> Better | 0.001 | 0 | 0 | 0 |
|  |  |  | Worse | Worse |  |  |
|  | GC-NU | $t$ test $p$ <br> Better | 0 <br> Worse | 0 | 0 | 0 |
|  |  |  |  | Worse | Worse |  |
...
[20] N. Luo, F. Qian, Estimation of distribution algorithm sampling under Gaussian and Cauchy distribution in continuous domain, in: Proc. IEEE Int. Conf. Control and Automation, Xiamen, China, 2010, pp. 1716-1720.
...
[48] T. James, R. Thaine, T. Kaylee, K. Dakoda, L. Cody, P. Makenzie, Dynamic link budget simulation for high altitude balloon data link experiment, in: Proc. 18th Symp. Communications and Networking, 2015, pp. 32-36.
