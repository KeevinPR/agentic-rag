...
| :--: | :--: | :--: | :--: |
| F1 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(\bar{x})=x_{1} \\ & f_{2}(\bar{x})=g(\bar{x})\left[1-\sqrt{f_{1}(\bar{x}) / g(\bar{x})}\right] \\ & g(\bar{x})=1+\theta\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | Convex PF <br> Linear linkage $n=50$ <br> The $P S$ is a line segment: $x_{n}=\cdots=x_{2}=x_{1}, 0 \leq x_{1} \leq 1$ |
| F2 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(\bar{x})=x_{1} \\ & f_{2}(\bar{x})=g(\bar{x})\left[1-\left(f_{1}(\bar{x}) / g(\bar{x})\right)^{2}\right] \\ & g(\bar{x})=1+\theta\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | Concave PF <br> Linear linkage $n=50$ <br> The $P S$ is a line segment: $x_{n}=\cdots=x_{2}=x_{1}, 0 \leq x_{1} \leq 1$ |
| F3 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(\bar{x})=\cos \left(\frac{\pi}{2} x_{1}\right) \cos \left(\frac{\pi}{2} x_{2}\right)(1+g(\bar{x})) \\ & f_{2}(\bar{x})=\cos \left(\frac{\pi}{2} x_{1}\right) \sin \left(\frac{\pi}{2} x_{2}\right)(1+g(\bar{x})) \\ & f_{3}(\bar{x})=\sin \left(\frac{\pi}{2} x_{1}\right)(1+g(\bar{x})) \\ & g(\bar{x})=\sum_{i=1}^{n}\left(x_{i}-x_{1}\right)^{2} \end{aligned}$ | Concave PF <br> Linear linkage <br> 3 objectives <br> $n=50$ <br> The $P S$ is a 2-D rectangle: $x_{n}=\ldots=x_{3}=x_{1}, 0 \leq x_{1}, x_{2} \leq 1$ |
| F4 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(\bar{x})=x_{1} \\ & f_{2}(\bar{x})=g(\bar{x})\left[1-\sqrt{f_{1}(\bar{x}) / g(\bar{x})}\right] \\ & g(\bar{x})=1+\theta\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | Convex PF <br> Nonlinear linkage $n=50$ <br> The $P S$ is a bounded continuous conic: $x_{n}=\cdots=x_{2}=\sqrt{x_{1}}, 0 \leq x_{1} \leq 1$ |
| F5 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(\bar{x})=x_{1} \\ & f_{2}(\bar{x})=g(\bar{x})\left[1-\left(f_{1}(\bar{x}) / g(\bar{x})\right)^{2}\right] \\ & g(\bar{x})=1+\theta\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | Concave PF <br> Nonlinear linkage <br> $n=50$ <br> The $P S$ is a bounded continuous conic: $x_{n}=\cdots=x_{2}=\sqrt{x_{1}}, 0 \leq x_{1} \leq 1$ |
| F6 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(\bar{x})=\cos \left(\frac{\pi}{2} x_{1}\right) \cos \left(\frac{\pi}{2} x_{2}\right)(1+g(\bar{x})) \\ & f_{2}(\bar{x})=\cos \left(\frac{\pi}{2} x_{1}\right) \sin \left(\frac{\pi}{2} x_{2}\right)(1+g(\bar{x})) \\ & f_{3}(\bar{x})=\sin \left(\frac{\pi}{2} x_{1}\right)(1+g(\bar{x})) \\ & g(\bar{x})=\sum_{i=1}^{n}\left(x_{i}^{2}-x_{1}\right)^{2} \end{aligned}$ | Concave PF <br> Nonlinear linkage <br> 3 objectives <br> $n=30$ <br> The $P S$ is a 2-D surface: $x_{n}=\cdots=x_{3}=\sqrt{x_{1}}, 0 \leq x_{1}$, $x_{2} \leq 1$ |
| F7 | $[0,1]=[-1,1]^{n-1}$ | $\begin{aligned} & f_{1}(\bar{x})=x_{1} \\ & f_{2}(\bar{x})=g(\bar{x})\left[1-\sqrt{f_{1}(\bar{x}) / g(\bar{x})}\right] \\ & g(\bar{x})=1+\theta\left(\sum_{i=2}^{n}\left(x_{i}-\sin \left(2 \pi x_{1}\right)\right)^{2}\right) /(n-1) \end{aligned}$ | Convex PF <br> Nonlinear linkage $n=30$ <br> The $P S$ is a period continuous sine curve: $x_{n}=\cdots=x_{2}=\sin \left(2 \pi x_{1}\right)$, $0 \leq x_{1} \leq 1$ |
...
| Instance | The number of FES | IRM-MEDA | MOEA/D-DE |
| :--: | :--: | :--: | :--: |
|  |  | Mean IGD $\pm$ Std Dev $\left(\times 10^{-3}\right)$ | Mean IGD $\pm$ Std Dev $\left(\times 10^{-3}\right)$ |
