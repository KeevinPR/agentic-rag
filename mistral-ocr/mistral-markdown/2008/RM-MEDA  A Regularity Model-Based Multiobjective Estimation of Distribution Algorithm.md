...
| :--: | :--: | :--: | :--: |
| F1 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=x_{1} \\ & f_{2}(x)=g(x)\left[1-\sqrt{f_{1}(x) / g(x)}\right] \\ & g(x)=1+9\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | convex PF <br> linear variable linkage |
| F2 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=x_{1} \\ & f_{2}(x)=g(x)\left[1-\left(f_{1}(x) / g(x)\right)^{2}\right] \\ & g(x)=1+9\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | concave PF <br> linear variable linkage |
| F3 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=1-\exp \left(-4 x_{1}\right) \sin ^{6}\left(6 \pi x_{1}\right) \\ & f_{2}(x)=g(x)\left[1-\left(f_{1}(x) / g(x)\right)^{2}\right] \\ & g(x)=1+9\left(\sum_{i=2}^{n}\left(x_{i}-x_{1}\right)^{2}\right) 9\left[{ }^{0.25} \right. \end{aligned}$ | concave PF <br> nonuniformly distributed <br> linear variable linkage |
| F4 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=\cos \left(\frac{\pi}{2} x_{1}\right) \cos \left(\frac{\pi}{2} x_{2}\right)(1+g(x)) \\ & f_{2}(x)=\cos \left(\frac{\pi}{2} x_{1}\right) \sin \left(\frac{\pi}{2} x_{2}\right)(1+g(x)) \\ & f_{3}(x)=\sin \left(\frac{\pi}{2} x_{1}\right)(1+g(x)) \\ & g(x)=\sum_{i=3}^{n}\left(x_{i}-x_{1}\right)^{2} \end{aligned}$ | concave PF <br> linear variable linkage <br> 3 objectives |
| F5 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=x_{1} \\ & f_{2}(x)=g(x)\left[1-\sqrt{x_{1} / g(x)}\right] \\ & g(x)=1+9\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | convex PF <br> nonlinear variable linkage |
| F6 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=\sqrt{x_{1}} \\ & f_{2}(x)=g(x)\left[1-\left(f_{1}(x) / g(x)\right)^{2}\right] \\ & g(x)=1+9\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) /(n-1) \end{aligned}$ | concave PF <br> nonlinear variable linkage |
| F7 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=1-\exp \left(-4 x_{1}\right) \sin ^{5}\left(6 \pi x_{1}\right) \\ & f_{2}(x)=g(x)\left[1-\left(f_{1}(x) / g(x)\right)^{2}\right] \\ & g(x)=1+9\left(\sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}\right) 9\left[{ }^{0.25} \right. \end{aligned}$ | concave PF <br> nonuniformly distributed <br> nonlinear variable linkage |
| F8 | $[0,1]^{n}$ | $\begin{aligned} & f_{1}(x)=\cos \left(\frac{\pi}{2} x_{1}\right) \cos \left(\frac{\pi}{2} x_{2}\right)(1+g(x)) \\ & f_{2}(x)=\cos \left(\frac{\pi}{2} x_{1}\right) \sin \left(\frac{\pi}{2} x_{2}\right)(1+g(x)) \\ & f_{3}(x)=\sin \left(\frac{\pi}{2} x_{1}\right)(1+g(x)) \\ & g(x)=\sum_{i=3}^{n}\left(x_{i}^{2}-x_{1}\right)^{2} \end{aligned}$ | concave PF <br> nonlinear variable linkage <br> 3 objectives |
| F9 | $\begin{aligned} & {[0,1] \times} \\ & {[0,10]^{n-1}} \end{aligned}$ | $\begin{aligned} & f_{1}(x)=x_{1} \\ & f_{2}(x)=g(x)\left[1-\sqrt{f_{1}(x) / g(x)}\right] \\ & g(x)=\frac{1}{4000} \sum_{i=2}^{n}\left(x_{i}^{2}-x_{1}\right)^{2}-\prod_{i=2}^{n} \cos \left(\frac{\left(x_{i}^{2}-x_{1}\right)}{\sqrt{i-1}}\right)+2 \end{aligned}$ | concave PF <br> nonlinear variable linkage <br> multimodal with Griewank function |
| F10 | $\begin{aligned} & {[0,1] \times} \\ & {[0,10]^{n-1}} \end{aligned}$ | $\begin{aligned} & f_{1}(x)=x_{1} \\ & f_{2}(x)=g(x)\left[1-\sqrt{f_{1}(x) / g(x)}\right] \\ & g(x)=1+10(n-1)+\sum_{i=2}^{n}\left[\left(x_{i}^{2}-x_{1}\right)^{2}-10 \cos \left(2 \pi\left(x_{i}^{2}-x_{1}\right)\right)\right] \end{aligned}$ | concave PF <br> nonlinear variable linkage <br> multimodal with Rastrigin function |
