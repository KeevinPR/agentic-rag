...
| Parameter | Symbol | Value $\pm$ Tolerance ${ }^{\text {a }}$ | Unit |
| :--: | :--: | :--: | :--: |
| Number of FBGs | $M$ | 20 | - |
| Bragg wavelengths | $\lambda_{\mathrm{B}, \mathrm{m}} \pm \sigma_{\lambda_{\mathrm{B}}}$ | $1550 \pm 0.1$ | nm |
| FBG spectral bandwidth (FWHM) | $\Delta \lambda_{\text {FWHM }} \pm \sigma_{\Delta \lambda}$ | $200 \pm 20$ | pm |
| FBG peak reflectivities | $R_{\mathrm{B}, \mathrm{m}} \pm \sigma_{\mathrm{B}_{\mathrm{B}}}$ | $0.5 \pm 0.1$ | $\%$ |
| FBG positions $m=1,2, \ldots, 10$ | $z_{m} \pm \sigma_{z}$ | $2.0,2.2, \ldots, 3.8 \pm 0.02$ | m |
| FBG positions $m=11,12, \ldots, 20$ |  | $5.8,6.1, \ldots, 8.5 \pm 0.03$ |  |
| Number of simulation runs | $N_{\text {sim }}$ | 1000 | - |
| Modulation frequencies | $f_{k}$ | $10 \ldots 500$ | MHz |
| Modulation frequency steps | $\Delta f$ | 10 | MHz |
| Measurement wavelengths | $\lambda_{n}$ | $1549 \ldots 1551$ | nm |
| Measurement wavelength steps | $\Delta \lambda$ | 40 | pm |
| Additional Gaussian noise (RMS) | $\sigma_{n}$ | $1.5 \times 10^{-5}$ | - |
| Fiber group refractive index | $n_{\mathrm{g}}$ | 1.447 | - |
| Fiber attenuation coefficient | $\alpha$ | 0.25 | $\mathrm{dB} / \mathrm{km}$ |
...
| :--: | :--: | :--: | :--: |
| Measurement temperature range | $T$ | $-20 \ldots 85$ | ${ }^{\circ} \mathrm{C}$ |
| Measurement temperature steps | $\Delta T$ | 15 | K |
| Number of measurements per temperature | $N_{\text {meas }}$ | 100 | - |
| Modulation frequencies | $f_{k}$ | $10 \ldots 500$ | MHz |
| Modulation frequency steps | $\Delta f$ | 10 | MHz |
| VNA intermediate frequency bandwidth | $B_{\text {IF }}$ | 1 | kHz |
| Measurement wavelengths | $\lambda_{n}$ | $1539 \ldots 1541$ | nm |
| Measurement wavelength steps | $\Delta \lambda$ | 40 | pm |
| Average fiber coupled optical power | $P_{0}$ | $-5$ | dBm |
| Fiber group refractive index | $n_{\mathrm{g}}$ | 1.447 | - |
| Fiber attenuation coefficient | $\alpha$ | 0.25 | $\mathrm{dB} / \mathrm{km}$ |
...
1. Ding, Z.; Wang, C.; Liu, K.; Jiang, J.; Yang, D.; Pan, G.; Pu, Z.; Liu, T. Distributed Optical Fiber Sensors Based on Optical Frequency Domain Reflectometry: A review. Sensors 2018, 18, 1072. [CrossRef] [PubMed]
2. Denisov, A.; Soto, M.A.; Thévenaz, L. Going beyond 1000000 resolved points in a Brillouin distributed fiber sensor: Theoretical analysis and experimental demonstration. Light Sci. Appl. 2016, 5, e16074. [CrossRef]
3. Barrias, A.; Casas, J.R.; Villalba, S. A Review of Distributed Optical Fiber Sensors for Civil Engineering Applications. Sensors 2016, 16, 748. [CrossRef] [PubMed]
4. Bao, X.; Chen, L. Recent Progress in Distributed Fiber Optic Sensors. Sensors 2012, 12, 8601-8639. [CrossRef] [PubMed]
5. Soto, M.A.; Bolognini, G.; Pasquale, F.D. Analysis of optical pulse coding in spontaneous Brillouin-based distributed temperature sensors. Opt. Express 2008, 16, 19097-19111. [CrossRef] [PubMed]
6. Jones, M.D. Using simplex codes to improve OTDR sensitivity. IEEE Photonics Technol. Lett. 1993, 5, 822-824. [CrossRef]
7. Werzinger, S.; Bergdolt, S.; Engelbrecht, R.; Thiel, T.; Schmauss, B. Quasi-Distributed Fiber Bragg Grating Sensing Using Stepped Incoherent Optical Frequency Domain Reflectometry. IEEE J. Lightwave Technol. 2016, 34, 5270-5277. [CrossRef]
8. Soller, B.J.; Gifford, D.K.; Wolfe, M.S.; Froggatt, M.E. High resolution optical frequency domain reflectometry for characterization of components and assemblies. Opt. Express 2005, 13, 666-674. [CrossRef] [PubMed]
9. Karamehmedovic, E.; Glombitza, U. Fiber optic distributed temperature sensor using incoherent optical frequency domain reflectometry. In Preceedings of the Emerging Optoelectronic Applications, San Jose, CA, USA, 25 June 2004; pp. 107-115.
10. Saxena, M.K.; Raju, S.D.V.S.J.; Arya, R.; Ravindranath, S.; Kher, S.; Oa, S. Raman optical fiber distributed temperature sensor using wavelet transform based simplified signal processing of Raman backscattered signals. Opt. Laser Technol. 2015, 65, 14-24. [CrossRef]
11. Farahani, M.A.; Wylie, M.T.V.; Castillo-Guerra, E.; Colpitts, B.G. Reduction in the Number of Averages Required in BOTDA Sensors Using Wavelet Denoising Techniques. J. Lightwave Technol. 2012, 30, 1134-1142. [CrossRef]
12. Soto, M.A.; Ramírez, J.A.; Thévenaz, L. Intensifying the response of distributed optical fibre sensors using 2D and 3D image restoration. Nat. Commun. 2016, 7, 10870. [CrossRef] [PubMed]

13. Tejedor, J.; Macias-Guarasa, J.; Martins, H.F.; Pastor-Graells, J.; Corredera, P.; Martin-Lopez, S. Machine Learning Methods for Pipeline Surveillance Systems Based on Distributed Acoustic Sensing: A Review. Appl. Sci. 2017, 7, 841. [CrossRef]
14. Candy, J.V. Model-Based Signal Processing, 1st ed.; John Wiley \& Sons: New York, NY, USA, 2006.
15. Werzinger, S.; Gottinger, M.; Gussner, S.; Bergdolt, S.; Engelbrecht, R.; Schmauss, B. Model-based compressed sensing of fiber Bragg grating arrays in the frequency domain. In Proceedings of the 25th International Conference on Optical Fiber Sensors, Jeju, Korea, 24-28 April 2017; pp. 103236H-1-103236H-4.
16. Kersey, A.D.; Davis, M.A.; Patrick, H.J.; LeBlanc, M.; Koo, K.P.; Askins, C.G.; Putnam, M.A.; Friebele, E.J. Fiber grating sensors. IEEE J. Lightwave Technol. 1997, 15, 1442-1463. [CrossRef]
17. Rao, Y.J. In-fibre Bragg grating sensors. Meas. Sci. Technol. 1997, 8, 355. [CrossRef]
18. Chiavaioli, F.; Baldini, F.; Tombelli, S.; Trono, C.; Giannetti, A. Biosensing with optical fiber gratings. Nanophotonics 2017, 6, 663-679. [CrossRef]
19. Kashyap, R. Fiber Bragg Gratings, 2nd ed.; Academic Press: Cambridge, MA, USA, 2009.
20. Morey, W.W.; Dunphy, J.R.; Meltz, G. Multiplexing fiber Bragg grating sensors. Fiber Integr. Opt. 1991, 10, 351-360. [CrossRef]
21. Cooper, D.J.F.; Coroy, T.; Smith, P.W.E. Time-division multiplexing of large serial fiber-optic Bragg grating sensor arrays. Appl. Opt. 2001, 40, 2643-2654. [CrossRef] [PubMed]
22. Yang, M.; Bai, W.; Guo, H.; Wen, H.; Yu, H.; Jiang, D. Huge capacity fiber-optic sensing network based on ultra-weak draw tower gratings. Photonic Sens. 2016, 6, 26-41. [CrossRef]
23. Luo, Z.; Wen, H.; Guo, H.; Yang, M. A time- and wavelength-division multiplexing sensor network with ultra-weak fiber Bragg gratings. Opt. Express 2013, 21, 22799-22807. [CrossRef] [PubMed]
24. Harris, F.J. On the use of windows for harmonic analysis with the discrete Fourier transform. Proc. IEEE 1978, 66, 51-83. [CrossRef]
25. Guo, H.; Qian, L.; Zhou, C.; Zheng, Z.; Yuan, Y.; Xu, R.; Jiang, D. Crosstalk and ghost gratings in a large-scale weak fiber Bragg grating array. IEEE J. Lightwave Technol. 2017, 35, 2032-2036. [CrossRef]
26. MacDonald, R.I. Frequency domain optical reflectometer. Appl. Opt. 1981, 20, 1840-1844. [CrossRef] [PubMed]
27. Uttam, D.; Culshaw, B. Precision time domain reflectometry in optical fiber systems using a frequency modulated continuous wave ranging technique. IEEE J. Lightwave Technol. 1985, 3, 971-977. [CrossRef]
28. Ghafoori-Shiraz, H.; Okoshi, T. Optical frequency-domain reflectometery. Opt. Quant. Electron. 1986, 18, 265-272. [CrossRef]
29. Nakayama, J.; Iizuka, K.; Nielsen, J. Optical fiber fault locator by the step frequency method. Appl. Opt. 1987, 26, 440-443. [CrossRef] [PubMed]
30. Koeppel, M.; Werzinger, S.; Ringel, T.; Bechtold, P.; Thiel, T.; Engelbrecht, R.; Bosselmann, T.; Schmauss, B. Combined distributed Raman and Bragg fiber temperature sensing using incoherent optical frequency domain reflectometry. J. Sens. Sens. Syst. 2018, 7, 91-100. [CrossRef]
31. Liehr, S.; Krebber, K.Application of Quasi-Distributed and Dynamic Length and Power Change Measurement Using Optical Frequency Domain Reflectometry. IEEE Sens. J. 2012, 12, 237-245. [CrossRef]
32. Barnoski, M.K.; Rourke, M.D.; Jensen, S.M.; Melville, R.T. Optical time domain reflectometer. Appl. Opt. 1977, 16, 2375-2379. [CrossRef] [PubMed]
33. Personick, S.D. Photon Probe-An Optical-Fiber Time-Domain Reflectometer. Bell Syst. Tech. J. 1977, 56, 355-366. [CrossRef]
34. Iizuka, K.; Freundorfer, A.P.; Wu, K.H.; Mori, H.; Ogura, H.; Nguyen, V.K. Step-frequency radar. J. Appl. Phys. 1984, 56, 2572-2583. [CrossRef]
35. Erdogan, T. Fiber grating spectra. J. Lightwave Technol. 1997, 15, 1277-1294. [CrossRef]
36. Yariv, A. Coupled-mode theory for guided-wave optics. IEEE J. Quantum Electron. 1973, 9, 919-933. [CrossRef]
37. Larrañaga, P.; Lozano, J.A. (Eds.) Estimation of Distribution Algorithms; Springer: Boston, MA, USA, 2002.

38. Hauschild, M.; Pelikan, M. An introduction and survey of estimation of distribution algorithms. Swarm Evol. Comput. 2011, 1, 111-128. [CrossRef]
39. Tosi, D. Review and Analysis of Peak Tracking Techniques for Fiber Bragg Grating Sensors. Sensors 2017, 17, 2368. [CrossRef] [PubMed]
