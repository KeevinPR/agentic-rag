...
| Function | GA | UMDA | PBIL | MIMIC | $\begin{aligned} & \text { $\beta- } \\ & \text { QEDA } \end{aligned}$ | $\begin{aligned} & \text { M- } \\ & \text { QEDA } \end{aligned}$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
...
| Function | GA |  | UMD <br> A | PBIL | MIMIC | $\begin{gathered} \text { $\beta-$ } \\ \text { QED } \\ \text { A } \end{gathered}$ | $\begin{gathered} \text { M- } \\ \text { QC } \\ \text { D } \\ \text { A } \end{gathered}$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| Sp he re | average | $\begin{aligned} & 1.1200 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 9.200 \\ & \text { 0E- } \\ & \text { 04 } \end{aligned}$ | $\begin{aligned} & 8.4000 \\ & \text { E-04 } \end{aligned}$ | $\begin{aligned} & 4.5600 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 3.200 \\ & \text { 0E-04 } \end{aligned}$ | 0 |
|  | Standard deviation | $\begin{aligned} & 1.0029 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 1.006 \\ & \text { 9E- } \\ & \text { 03 } \end{aligned}$ | $\begin{aligned} & 9.9714 \\ & \text { E-04 } \end{aligned}$ | $\begin{aligned} & 1.9290 \\ & \text { E-02 } \end{aligned}$ | $\begin{aligned} & 7.406 \\ & \text { 6E-04 } \end{aligned}$ | 0 |
|  | Worst value | $\begin{aligned} & 2.0000 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 2.000 \\ & \text { 0E- } \\ & \text { 03 } \end{aligned}$ | $\begin{aligned} & 2.0000 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 1.2800 \\ & \text { E-01 } \end{aligned}$ | $\begin{aligned} & 2.000 \\ & \text { 0E-03 } \end{aligned}$ | 0 |
| Q $\begin{aligned} & \text { us } \\ & \text { dti } \\ & \text { c } \end{aligned}$ | Average <br> Standard deviation | $\begin{aligned} & 0.5166 \\ & 2.5801 \end{aligned}$ | $\begin{aligned} & 1.136 \\ & 5 \\ & 6 \end{aligned}$ | 0.1091 | 0.3731 | $\begin{aligned} & 0.028 \\ & 7 \end{aligned}$ | 0 |
|  | Worst value | $\begin{aligned} & 18.3680 \\ & 5.7299 \end{aligned}$ | $\begin{aligned} & 23.24 \\ & 70 \end{aligned}$ | 0.2870 | 7.7150 | $\begin{aligned} & 0.287 \\ & 0 \end{aligned}$ | 0 |
| $\begin{aligned} & \text { Sc } \\ & \text { ha } \\ & \text { ffe } \end{aligned}$ | average <br> Standard deviation | $\begin{aligned} & 5.7299 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 3.196 \\ & 7 E- \\ & 03 \end{aligned}$ | $\begin{aligned} & 5.5335 \\ & \text { E-04 } \end{aligned}$ | $\begin{aligned} & 4.1733 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 3.814 \\ & 5 E- \\ & \text { OS } \end{aligned}$ | $\begin{aligned} & 0 \\ & 0 \end{aligned}$ |
| r | Standard deviation | $\begin{aligned} & 5.0882 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 4.141 \\ & 8 \mathrm{E}- \\ & 03 \end{aligned}$ | $\begin{aligned} & 1.5937 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 4.9006 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 7.706 \\ & 4 \mathrm{E}-05 \end{aligned}$ | 0 |
|  | Worst value | $\begin{aligned} & 1.2625 \\ & \text { E-02 } \end{aligned}$ | $\begin{aligned} & 1.419 \\ & 3 \mathrm{E}- \\ & 02 \end{aligned}$ | $\begin{aligned} & 9.5638 \\ & \text { E-03 } \end{aligned}$ | $\begin{aligned} & 1.8953 \\ & \text { E-02 } \end{aligned}$ | $\begin{aligned} & 1.907 \\ & 2 \mathrm{E}-04 \end{aligned}$ | 0 |
| $\begin{aligned} & \text { Gr } \\ & \text { se } \\ & \text { wa } \\ & \text { ok } \end{aligned}$ | average <br> Standard deviation | $\begin{aligned} & 0.3550 \\ & 0.4045 \end{aligned}$ | $\begin{aligned} & 0.462 \\ & 0.457 \\ & 2 \end{aligned}$ | 0.2582 | 0.3478 | $\begin{aligned} & 0.080 \\ & 7 \end{aligned}$ | 0 |
|  | Worst value | 0.8068 | $\begin{aligned} & 1.164 \\ & 5 \end{aligned}$ | 0.8068 | 1.0400 | $\begin{aligned} & 0.806 \\ & 8 \end{aligned}$ | 0 |
| $\begin{aligned} & \text { R } \\ & \text { os } \\ & \text { en } \\ & \text { br } \\ & \text { oc } \\ & \text { k } \end{aligned}$ | average <br> Standard deviation | $\begin{aligned} & 5.9197 \\ & 7.7090 \end{aligned}$ | $\begin{aligned} & 0.581 \\ & 1.451 \end{aligned}$ | 0.0038 | 1.3108 | $\begin{aligned} & 0.015 \\ & 2 \end{aligned}$ | 0 |
|  | Worst value | 19.5757 | $\begin{aligned} & 7.753 \\ & 8 \end{aligned}$ | 0.1881 | 19.5757 | $\begin{aligned} & 0.195 \\ & 7 \end{aligned}$ | 0 |
| $\begin{aligned} & \text { Ra } \\ & \text { str } \end{aligned}$ | average | 9.3978 | $\begin{aligned} & 3.420 \\ & 6 \end{aligned}$ | 0.1190 | 2.3572 | $\begin{aligned} & 0.047 \\ & 6 \end{aligned}$ | 0 |

| $\begin{aligned} & \text { qj } \\ & \text { n } \end{aligned}$ | Standard deviation | 14.5125 | $\begin{aligned} & 6.213 \\ & 3 \end{aligned}$ | 0.1836 | 5.6836 | $\begin{aligned} & 0.130 \\ & 2 \end{aligned}$ | 0 |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
|  | Worst value | 79.9851 | $\begin{aligned} & 20.78 \\ & 51 \end{aligned}$ | 0.3967 | 20.0000 | $\begin{aligned} & 0.396 \\ & 7 \end{aligned}$ | 0 |

Table 3 The average running time of each algorithm

| function | GA | UMDA | PBIL | MIMIC | $\begin{aligned} & \text { ® } \\ & \text { QEDA } \end{aligned}$ | $\begin{aligned} & \text { M- } \\ & \text { QEDA } \end{aligned}$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
