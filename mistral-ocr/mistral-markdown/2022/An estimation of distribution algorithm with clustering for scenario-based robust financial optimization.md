...
|  |  | NSEDA- <br> C | NSEDA | 10 MC | 20 MC | 50 MC | DEMO | MOPSO | DEMON | NSGA-II$\alpha$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| $\begin{aligned} & t_{0}=3045 \\ & 50 \\ & T=20 \end{aligned}$ | $\begin{aligned} & \text { IGD } \\ & \text { 0 } \end{aligned}$ | $\begin{aligned} & 5.781 \mathrm{E}+ \\ & 04 \end{aligned}$ | $\begin{aligned} & 7.105 \mathrm{E}+ \\ & 04 \end{aligned}$ | $\begin{aligned} & 8.296 \mathrm{E}+ \\ & 04 \end{aligned}$ | $\begin{aligned} & 9.298 \mathrm{E}+ \\ & 04 \end{aligned}$ | $\begin{aligned} & 1.073 \mathrm{E}+ \\ & 05 \end{aligned}$ | $\begin{aligned} & 1.007 \mathrm{E}+ \\ & 05 \end{aligned}$ | $\begin{aligned} & 9.622 \mathrm{E}+ \\ & 04 \end{aligned}$ | $\begin{aligned} & 3.954 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 8.739 \mathrm{E}+ \\ & 04 \end{aligned}$ |
|  | $p$ value | $-$ | $\begin{aligned} & 3.020 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.020 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.020 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 4.573 \mathrm{E}- \\ & 09^{*} \end{aligned}$ | $\begin{aligned} & 5.494 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.020 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.020 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.020 \mathrm{E}- \\ & 11^{*} \end{aligned}$ |
|  | S | $\begin{aligned} & 8.361 \mathrm{E}+ \\ & 05 \end{aligned}$ | $\begin{aligned} & 1.490 \mathrm{E}+ \\ & 06 \end{aligned}$ | $\begin{aligned} & 1.209 \mathrm{E}+ \\ & 06 \end{aligned}$ | $\begin{aligned} & 2.092 \mathrm{E}+ \\ & 06 \end{aligned}$ | $\begin{aligned} & 1.045 \mathrm{E}+ \\ & 06 \end{aligned}$ | $\begin{aligned} & 1.688 \mathrm{E}+ \\ & 06 \end{aligned}$ | $\begin{aligned} & 4.884 \mathrm{E}+ \\ & 05 \end{aligned}$ | $\begin{aligned} & 8.935 \mathrm{E}+ \\ & 06 \end{aligned}$ | $\begin{aligned} & 7.854 \mathrm{E}+ \\ & 05 \end{aligned}$ |
| $t_{0}=3045$ | IGD | $\begin{aligned} & 2.853 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.854 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.857 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.859 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.857 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.857 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.855 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 7.305 \mathrm{E}+ \\ & 07 \end{aligned}$ | $\begin{aligned} & 2.855 \mathrm{E}+ \\ & 07 \end{aligned}$ |
| $T=30$ | $p$ value | $-$ | $\begin{aligned} & 1.777 \mathrm{E}- \\ & 10^{*} \end{aligned}$ | $\begin{aligned} & 4.077 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 6.696 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.474 \mathrm{E}- \\ & 10^{*} \end{aligned}$ | $\begin{aligned} & 5.072 \mathrm{E}- \\ & 10^{*} \end{aligned}$ | $\begin{aligned} & 2.034 \mathrm{E}- \\ & 09^{*} \end{aligned}$ | $\begin{aligned} & 4.975 \mathrm{E}- \\ & 11^{*} \end{aligned}$ | $\begin{aligned} & 3.835 \mathrm{E}- \\ & 06^{*} \end{aligned}$ |
...
21. Yang Q, Chen WN, Li Y et al (2017) Multimodal estimation of distribution algorithms. IEEE Trans Cybern 47:636-650
